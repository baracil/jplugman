...
public class PluggedPlugin extends PluginBase {

    public PluggedPlugin(long id, @NonNull ModuleLayer moduleLayer, @NonNull Plugin plugin) {
        super(id, moduleLayer, plugin);
    }

    @Override
    public @NonNull PluginState getState() {
        return PluginState.PLUGGED;
    }
}
